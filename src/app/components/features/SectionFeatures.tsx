    ...
    return <section className={'site-section-generate-feature'}>
        <div className={'site-container'}>
            ...
            <ul className={'site-section-generate-feature-row'}>
                ...
                <li>
                    <div className={'site-section-generate-feature-image'}><Image src={ContentOutput} /></div>
                ...
                <li>
                    <div className={'site-section-generate-feature-image'}> <Image src={Globe} /></div>
                ...
                <li>
                    <div className={'site-section-generate-feature-image'}><Image src={Ideas} /></div>
                ...
                <li>
                    <div className={'site-section-generate-feature-image'}><Image src={Ideas2} /></div>
                ...
                <li>
                    <div className={'site-section-generate-feature-image'}><Image src={Build} /></div>
